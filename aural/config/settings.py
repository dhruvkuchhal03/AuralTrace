...
DATABASES = {
    'mysql': ("aural.database_handler.mysql_database", "MySQLDatabase"),
    'postgres': ("aural.database_handler.postgres_database", "PostgreSQLDatabase")
}
...
# is the value used in the original aural code).
...
# for Aural to consider it a spectral peak. Higher values mean less
